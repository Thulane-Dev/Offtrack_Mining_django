...
load_dotenv(BASE_DIR / ".env")  # 👈 THIS is the fix
...
SECRET_KEY = 'django-insecure-l8v&upgnpj)g$hba^dok7r1)%dy9@u3h#3bk27x=ij1q!m0ob9'
...
# ALLOWED_HOSTS = [
#     'offtrackmining.co.za',
#     'www.offtrackmining.co.za',
#     'cp34-jhb.za-dns.com'
# ]
...
INSTALLED_APPS = [
    ...
    'django_htmx',  # Enable HTMX support
    "client",
    "products",
]
...
EMAIL_HOST = "mail.offtrackmining.co.za"
EMAIL_PORT = 465
EMAIL_USE_SSL = True
